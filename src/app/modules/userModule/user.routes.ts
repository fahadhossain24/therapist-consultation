...
userRouter.patch('/update/:id', authentication('patient', 'therapist', 'super-admin', 'admin'), requestValidator(UserValidationZodSchema.getSpecificUserZodSchema), userControllers.updateSpecificUser)
...
userRouter.get('/retrive/therapists/speciality/:speciality', authentication('patient', 'therapist'), userControllers.getAllTherapistsBySpeciality)
